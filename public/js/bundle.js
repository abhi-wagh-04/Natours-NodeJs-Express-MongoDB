      ...
      while (1) switch (_context.p = _context.n) {
        ...
        case 1:
          ...
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'You are logged in!!');
  ...
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        ...
        case 1:
          res = _context2.v;
          // location.reload(true) causes to re-render the page frommserver side
...
},{"axios":"../../node_modules/axios/index.js","./alert.js":"alert.js"}],"stripe.js":[function(require,module,exports) {
"use strict";
...
function _regeneratorDefine2(e, r, n, t) { var i = Object.defineProperty; try { i({}, "", {}); } catch (e) { i = 0; } _regeneratorDefine2 = function _regeneratorDefine(e, r, n, t) { if (r) i ? i(e, r, { value: n, enumerable: !t, configurable: !t, writable: !t }) : e[r] = n;else { function o(r, n) { _regeneratorDefine2(e, r, function (e) { return this._invoke(r, n, e); }); } o("next", 0), o("throw", 1), o("return", 2); } }, _regeneratorDefine2(e, r, n, t); }
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } // ✅ REMOVE this line:
// import Stripe from 'stripe';
// ✅ Use the Stripe object loaded from https://js.stripe.com/v3/
var stripe = Stripe('pk_test_51Rp02LAf0FfvCL5tzA1Eb9fre4gXyNvihuPbQnEd2Xy5nq7KPxRP6sgpXMnwipKRMHqZ8KKHUIGNpPUDwuKXwad900Agx9S7Ey');
